...
function seccion2() {
  const rows = [
    ...
    ["RF-W020","Notificaciones in-app","Notificaciones dentro de la app (Supabase Realtime). Sin push nativo.","Media","Notificación","Implementado"],
...
function seccion4() {
  ...
  const cus = [
    ...
    ["CU-20","Notificaciones in-app",
      ...
      "1. Evento (IPC nuevo, alerta margen). 2. API crea notifications. 3. Supabase Realtime → campana in-app. 4. Usuario marca leída.",
      "—",
      "Usuario ve título/cuerpo; sin push nativo (fuera de alcance TWA v1).",
      "E1: Realtime caído → lista al refrescar /api/notifications."],
...
function seccion7() {
  ...
  const modulos = [
    ...
    ["Historial","/history","Evolución de sale_price por producto (Chart.js). Tabla de price_history."],
...
function seccion9() {
  ...
  return [
    ...
    bullet("Julio 2026: defensa oral + demo en vivo ante el docente."),
    pb()
  ];
}
...
function seccion10() {
  const traz = [
    ...
    ["RF-W020","CU-20","CP-24","Notificaciones in-app (Supabase Realtime)"],
