...
**Versión:** 1.0 · **Tipo:** APK Android — no app nativa distinta  
**Build:** `scripts/build-preciosya-apk.mjs` → `apps/web/public/preciosya.apk`

## Contexto

La APK de PreciosYa **no es una aplicación nativa separada**. Es una APK Android que abre la misma PWA desplegada en `https://preciosya.vercel.app`, con verificación Digital Asset Links.
...
| RF-A003 | Abrir app en URL de producción | Must | La APK carga `preciosya.vercel.app`; login Google funciona |
...
| Aspecto | Web (Chrome/Safari) | APK Android |
|---------|---------------------|---------|
