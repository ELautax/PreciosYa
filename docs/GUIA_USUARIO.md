...
4. Al leerlo, volvés al formulario con el **código** cargado y, si hay coincidencia (Open Food Facts o un producto tuyo), el **nombre** (y unidad si se puede inferir). El **costo** y las **notas** las cargás vos. Pegar el código a mano no dispara esa búsqueda.
